...
export default function ProgramRelawanClient({ filters }: Props) {
	...
	return (
		<div className="space-y-4">
			<div className="w-fit rounded bg-primary text-white p-8 aspect">
				<div className="h-12">
					<MdiDoorSliding className="w-10 h-10" />
				</div>
				<div className="my-2">
					<h2 className="text-4xl font-bold">
						<span>
							{(dataProgramHarapan?.meta?.total || 0).toLocaleString()}
						</span>
					</h2>
				</div>
				<div>
					<p className="mt-2 font-sans text-base font-medium text-gray-200">
						Jumlah Data Program Harapan
					</p>
				</div>
			</div>
