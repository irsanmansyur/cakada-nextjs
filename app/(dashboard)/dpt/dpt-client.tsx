      ...
      <div className="space-y-3">
        ...
        <div className="header flex sm:justify-between flex-col sm:flex-row">
          ...
          <div className="my-2 flex items-center gap-1">
            ...
            <div className="pl-2">
              {/* <Dpt2024AddModal kabId={kabId} onSucces={onSuccessAddDpt}>
                <button
                  type="button"
                  className="inline-flex justify-center rounded-md border border-transparent bg-primary px-4 py-2 text-sm font-medium text-white hover:bg-primary/90 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 whitespace-nowrap"
                >
                  + DPT
                </button>
              </Dpt2024AddModal> */}
